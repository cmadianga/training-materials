\section{Prepare the STM32MP2 Discovery Kit}

The STM32MP2 Discovery Kit is powered via a USB-A or USB-C cable,
which you need to connect to the \code{CN21} (also labeled
\code{USB PWR STLNK}) connector.

Once your USB-A or USB-C cable is connected, a \code{/dev/ttyACM0} device
