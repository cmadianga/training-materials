...
As the code to support the STM32MP257F-DK is not fully in the official
upstream Linux kernel repository, we will also add stable release from
STMicroelectronis Linux kernel repository.
...
We will choose a particular stable version
\ifdefstring{\board}{stm32mp2}{from STMicroelectronics repository}{}
in the next labs.
