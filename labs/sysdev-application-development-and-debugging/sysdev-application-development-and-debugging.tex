...
\begin{bashinput}
$ %\ifdefstring{\labboardarch}{64bit}{aarch64-linux-gcc}{arm-linux-gcc}% -o nunchuk-mpd-client nunchuk-mpd-client.c
\end{bashinput}
...
On the host side, run \ifdefstring{\labboardarch}{64bit}{\code{aarch64-linux-gdb}}{\code{arm-linux-gdb}} (also found in your toolchain):
\begin{bashinput}
$ %\ifdefstring{\labboardarch}{64bit}{aarch64-linux-gdb}{arm-linux-gdb}% nunchuk-mpd-client
\end{bashinput}
...
Once you have such a file, inspect it with \ifdefstring{\labboardarch}{64bit}{\code{aarch64-linux-gdb}}{\code{arm-linux-gdb}}
